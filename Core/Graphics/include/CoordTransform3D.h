...
namespace GF {
	...
	public:
		...
		CoordTransform3D(glm::dvec3 translation_localToParent);
		CoordTransform3D(glm::dvec3 translation_localToParent, glm::dquat rotation_localToParent);
		CoordTransform3D(glm::dmat4 translation_localToParent = ROOT, glm::dmat4 rotation_localToParent = ROOT);
		...
		glm::dvec3 toParentSpace_position() const { return glm::dvec3(mTranslation_localToParent * glm::dvec4(0.0, 0.0, 0.0, 1.0)); }
		glm::dvec3 toParentSpace_position(glm::dvec3 position_local) const { return glm::dvec3(mTranslation_localToParent * glm::dvec4(position_local, 1.0)); }
		...
		glm::dvec3 toLocalSpace_position() const { return glm::dvec3(glm::inverse(mTranslation_localToParent) * glm::dvec4(0.0, 0.0, 0.0, 1.0)); }
		glm::dvec3 toLocalSpace_position(glm::dvec3 position_parent) const { return glm::dvec3(glm::inverse(mTranslation_localToParent) * glm::dvec4(position_parent, 1.0)); }
		...
		glm::dmat4 getLocalToParent_position() const { return mTranslation_localToParent; }
		glm::dmat4 getLocalToParent_rotation() const { return mRotation_localToParent; }

		void setLocalToParent_position(glm::dmat4 translation_localToParent);
