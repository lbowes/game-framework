...
IMGUI_API int           ImTextCharFromUtf8(unsigned* out_char, const char* in_text, const char* in_text_end);          // return input UTF-8 bytes count
...
static inline bool      ImCharIsBlankW(unsigned c)  { return c == ' ' || c == '\t' || c == 0x3000; }
...
#endif
// - ImMin/ImMax/ImClamp/ImLerp/ImSwap are used by widgets which support for variety of types: signed/unsigned/long long float/double, using templates here but we could also redefine them 6 times
