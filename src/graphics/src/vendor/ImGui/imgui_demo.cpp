...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("Combo"))
        {
            ...
            ImGui::CheckboxFlags("ImGuiComboFlags_PopupAlignLeft", (unsigned*)&flags, ImGuiComboFlags_PopupAlignLeft);
            if (ImGui::CheckboxFlags("ImGuiComboFlags_NoArrowButton", (unsigned*)&flags, ImGuiComboFlags_NoArrowButton))
                flags &= ~ImGuiComboFlags_NoPreview;     // Clear the other flag, as we cannot combine both
            if (ImGui::CheckboxFlags("ImGuiComboFlags_NoPreview", (unsigned*)&flags, ImGuiComboFlags_NoPreview))
        ...
        {
            // The DragScalar, InputScalar, SliderScalar functions allow manipulating most common data types: signed/unsigned/long long and float/double
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
    {
        ...
        ImGui::CheckboxFlags("io.ConfigFlags: NavEnableGamepad [beta]", (unsigned *)&io.ConfigFlags, ImGuiConfigFlags_NavEnableGamepad);
        ImGui::CheckboxFlags("io.ConfigFlags: NavEnableKeyboard [beta]", (unsigned *)&io.ConfigFlags, ImGuiConfigFlags_NavEnableKeyboard);
        ImGui::CheckboxFlags("io.ConfigFlags: NavEnableSetMousePos", (unsigned *)&io.ConfigFlags, ImGuiConfigFlags_NavEnableSetMousePos); 
        ...
        ImGui::CheckboxFlags("io.ConfigFlags: NoMouseCursorChange", (unsigned *)&io.ConfigFlags, ImGuiConfigFlags_NoMouseCursorChange);   
